...
function PassengerHistorySingleData({navigation, route}) {
  ...
  return (
    data &&
    data.passengerData &&
    driverProfilePicUrl && LATITUDE_DELTA && LONGITUDE_DELTA && (
      <View>
        ...
        <View
          ...
          <View style={{padding:10,paddingRight:0}} >
            ...
            <Text style={[styles.text,{fontSize:16}]} >
                  pickup: <Text style={{color:Colors.secondary,fontSize:14}} >  {data.passengerData.pickupAddress} </Text>
            </Text>
            </View>
            <View style={{flexDirection:"row",marginTop:3}} >
            <Text style={[styles.text,{fontSize:16}]} >
                  Dropoff: <Text style={{color:Colors.secondary,fontSize:14}} >  {data.passengerData.dropOffAddress} </Text>
            </Text>
            </View>

            <View style={{flexDirection:"row",marginTop:3}} >
            <Text style={[styles.text,{fontSize:16}]} >
                  payment: <Text style={{color:Colors.secondary,fontSize:16}} >  {data.payment}$ </Text>
            </Text>
            </View>
            <View style={{flexDirection:"row",marginTop:3}} >
            <Text style={[styles.text,{fontSize:16}]} >
                  Fare: <Text style={{color:Colors.secondary,fontSize:16}} >  {fare ? fare : data.driverData.fare}$ </Text>
            </Text>
            </View>
