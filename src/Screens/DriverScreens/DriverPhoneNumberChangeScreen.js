...
function DriverPhoneNumberChangeScreen({navigation, route}) {
...
const updatePhoneNumber = () => {
    ...
    firestore().collection("Drivers").doc(id).update({
        ...
        ToastAndroid.show("Your phone number has been successfully updated",ToastAndroid.SHORT)
  ...
  return (
    <View style={{flex: 1}}>
      ...
      <View style={{alignItems: 'center'}}>
        <View style={{borderWidth:1,borderColor:"black",width:"80%",marginTop:20,borderRadius:10,flexDirection:"row",alignItems:"center",paddingHorizontal:20}} >
...
export default DriverPhoneNumberChangeScreen;
