        ...
        const User = firestore()
            ...
            .onSnapshot(async (documentSnapshot) => {
                ...
                if (GetUserData.profilePicture.length) {
                    ...
                    const url = await storage().ref(GetUserData.profilePicture).getDownloadURL();
    ...
    return (
        <View style={styles.rootContainer}>
            <View style={styles.upperContainer}>
                <TouchableOpacity onPress={() => { navigation.navigate('DriverDetailsEdit', { driverData: driverData, profilePicUrl: profilePicUrl }) }}>
                    <Image
                        source={profilePicUrl ? { uri: profilePicUrl } : require('../../Assets/Images/dummyPic.png')}
                        style={styles.proPicStyles}
                    />
                </TouchableOpacity>
                <Text style={styles.proName}>{driverData.firstName} {driverData.lastName}</Text>
            </View>
            <View style={styles.fieldContainer}>
                <View style={styles.fieldItemContainer}>
                    <TouchableOpacity style={styles.fieldItem} onPress={() => { navigation.navigate('DriverHomeScreen') }}>
                        <MaterialCommunityIcons name="city" size={25} color={Colors.white} />
                ...
                <View style={styles.fieldItemContainer}>
                    <TouchableOpacity style={styles.fieldItem} onPress={() => { navigation.navigate('DriverVehicleEdit', { vehicleDetails: driverData.vehicleDetails }) }} >
                        <Ionicons name="md-car-sport-sharp" size={25} color={Colors.white} />
                        <Text style={styles.fieldItemText}>Vehicle</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.fieldItemContainer}>
                    <TouchableOpacity style={styles.fieldItem} onPress={() => { navigation.navigate('SettingsDriver') }}>
                ...
                <View style={styles.fieldItemContainer}>
                    <TouchableOpacity style={styles.fieldItem}>
                        <MaterialCommunityIcons name="message-question-outline" size={25} color={Colors.white} />
                        <Text style={styles.fieldItemText}>FAQ</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.fieldItemContainer}>
                    <TouchableOpacity style={styles.fieldItem}>
                        <MaterialCommunityIcons name="headphones" size={25} color={Colors.white} />
