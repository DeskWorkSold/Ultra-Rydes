                ...
                <>
                    <View style={styles.rootContainer}>
                        <View style={styles.upperContainer}>
                            <TouchableOpacity onPress={() => { navigation.navigate('PassengerDetailsEdit', { passengerData: passengerData, profilePicUrl: profilePicUrl }) }}>
                                <Image
                                    source={profilePicUrl ? { uri: profilePicUrl } : require('../../Assets/Images/dummyPic.png')}
                                    style={styles.proPicStyles}
                                />
                            </TouchableOpacity>
                            <Text style={styles.proName}>{passengerData.firstName} {passengerData.lastName}</Text>
                        </View>
                        <View style={styles.fieldContainer}>
                            <View style={styles.fieldItemContainer}>
                                <TouchableOpacity style={styles.fieldItem} onPress={() => { navigation.navigate('PassengerHomeScreen') }}>
                            ...
                            <View style={styles.fieldItemContainer}>
                                <TouchableOpacity style={styles.fieldItem} onPress={() => { navigation.navigate('SettingsPassenger') }}>
                            ...
                            <View style={styles.btnContainer}>
                                <CustomButton text='Driver Mode' onPress={switchToDriverHandler} />
                            </View>
                        </View>
                    </View></>}</>
    )
