 ...
 const getDriverData = async () => {
    ...
    useLayoutEffect(() => {
        navigation.setOptions({
            headerRight: () => {
                return (
                    <TouchableOpacity style={styles.cancelTextContainer} onPress={() => { navigation.navigate('PassengerHomeScreen') }}><Text style={styles.cancelText}>Cancel</Text></TouchableOpacity>
                );
            },
        });
    }, []);
            ...
            <View style={styles.card}>
                <View style={styles.innerItemsUpper}>
                    <View style={styles.imgContainer}>
                        ...
                        />
                        <View>
                            <Text style={styles.vehText}>{item.vehicleName}</Text>
                ...
                <View style={styles.btnContainer}>
                    <CustomButton text='Reject' styleContainer={styles.btn} btnTextStyle={styles.btnTextStyle} bgColor />
                    <CustomButton text='Accept' styleContainer={styles.btn} btnTextStyle={styles.btnTextStyle} />
                </View>
            </View>)
    }
    return (
