let  PassengerFaqContent = { 
  ...
  howToComplain : "If you did not enjoy your ride or if you had a conflict with the driver you can email us to ultraRydes@example.com",
  howToComplain2 : "We look into all Complaints and block drivers who violate the rules of our service.",
  howToFindBelongings : "if you have left the belonging in the car,email to us at ultraRydes@example.com,include the time and route of your ride,and if possible tell us the car's make,color and registration number we will help find your belongings.",
 }
